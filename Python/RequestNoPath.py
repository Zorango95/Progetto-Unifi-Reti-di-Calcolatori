...
which have a value "Path" that refers to a non-existent file.
"""
...
# Send a POST request with HTTP/1.0 version without the Host and non-existent file. It is managed with handler1_0.
print("Request POST HTTP/1.0; Host inexistent; Handler: Handler1_0; Path: file inexistent\n")
request = "POST /TestRequest.html HTTP/1.0\r\nConnection: Keep-alive\r\n\r\n"
comunication(request)

raw_input("\nPress enter to continue for next request\n")

# Send a POST request with HTTP/1.1 version without the correct Host and non-existent file.It is managed with handler1_0
print("Request POST HTTP/1.1; Host not correct: Mio.Pc; Handler: Handler1_1; Path: file inexistent\n")
request = "POST /TestRequest.html HTTP/1.1\r\nHost: Mio.Pc\r\nConnection: Close\r\n\r\n"
comunication(request)
