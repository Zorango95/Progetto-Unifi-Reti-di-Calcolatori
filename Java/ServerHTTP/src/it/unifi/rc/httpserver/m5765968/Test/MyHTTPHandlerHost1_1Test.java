...
/**
 * This class tests the processing of an HostHTTP/1.1 request.
 * 
 * @author Mattia D'Autilia
 */
public class MyHTTPHandlerHost1_1Test {

	private HTTPFactory myFactory;
	private HTTPHandler myHandlerHost1_1;
	private File myFile;
	 ...
	 * HostHTTPHandler1_1 to handle requests.
	 */
	@Before
	public void setUp() throws Exception {
		myFactory = new MyHTTPFactory();
		setfile();
		myHandlerHost1_1 = myFactory.getFileSystemHandler1_1("Mio.PC", myFile);
	}
	...
	public void testHost() throws IOException {
		newRequestHost();
		newReplyHost();
		currentReply = myHandlerHost1_1.handle(myRequest);
		controlHost();
	}
