...
/**
 * This class extends the MyHTTPHandler1_0 class with the task to handle only
 * requests whose host specified in their header rows matches the host specified
 * by the handler.
 * 
 * @author Mattia D'Autilia
 */
public class MyHTTPHandlerHost1_0 extends MyHTTPHandler1_0 {

	String myHost;

	/**
	 * Creates a HostHTTP/1.0 request handler, on the files searched by the main
	 ...
	 */
	public MyHTTPHandlerHost1_0(String host, File root) {
		super(root);
		this.myHost = " " + host;
	}
